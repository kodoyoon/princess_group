...
public enum ServiceAuthority {
    ...
    CREATE_LIST,
    // 하나의 리스트 수정 권한, domainId=targetListId
    UPDATE_LIST,
    ...
    // 특정 리스트 삭제 권한, domainId=targetListId
    DELETE_LIST,
    ...
    // 리스트 관리자 권한(리스트 권한 부여 가능), domainId=targetListId
    ROLE_LIST_ADMIN,
    // 특정 리스트에서 카드 생성 가능한 권한, domainId=targetListId
    CREATE_CARD_AT_LIST,
    ...
    UPDATE_CARD,
    // 리스트에 카드 순서 변경 권한, domainId=targetListId, 해당 권한이 없는 리스트에는 카드 순서 변경이 제한됨
    ...
    // 리스트에 존재하는 카드 수정 권한, domainId=targetListId
    ...
    DELETE_CARD,
    // 특정 리스트에 존재하는 카드 삭제 권한, domainId=targetListId
